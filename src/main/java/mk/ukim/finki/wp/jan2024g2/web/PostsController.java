...
public class PostsController {
    ...
    public String listAll(@RequestParam(required = false) Long tagId,
        ...
        if(tagId==null && postType==null){
            ...
            posts=this.postService.filterPosts(tagId,postType);
        }
    ...
    {
        this.postService.create(title,content,dateCreated,postType,tags);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam List<Long> tags)
    {
        this.postService.update(id, title,content,dateCreated,postType,tags);
        return "redirect:/posts";
    }
